...
import 'report_details_component_model.dart';
export 'report_details_component_model.dart';

/// Activity Tracking Summary
class ReportDetailsComponentWidget extends StatefulWidget {
  const ReportDetailsComponentWidget({
    super.key,
  ...
  @override
  State<ReportDetailsComponentWidget> createState() =>
      _ReportDetailsComponentWidgetState();
}

class _ReportDetailsComponentWidgetState
    extends State<ReportDetailsComponentWidget> {
  late ReportDetailsComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportDetailsComponentModel());
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            valueOrDefault<String>(
                              widget.reportParameter?.metadata.postureChanges
                                  .toString(),
                              '0',
                            ),
                            style: FlutterFlowTheme.of(context)
                        ...
                        children: [
                          ...
                          Text(
                            valueOrDefault<String>(
                              formatNumber(
                                widget
                                    .reportParameter?.metadata.standPercentage,
                                formatType: FormatType.custom,
                                format: '#.##',
                                locale: '',
                              ),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          functions.formatDateTime(
                              functions.toDateTime(
                                  widget.reportParameter!.startTime),
                              'dd.MM.yyyy HH:mm'),
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                ...
                Row(
                  ...
                  children: [
                    FutureBuilder<ApiCallResponse>(
                      future: BackBuddyAPIGroup.apiReportGetCall.call(
                        reportId: widget.reportParameter?.id,
                        expandType: 'DeviceLogs',
                        authToken: currentJwtToken,
                      ),
                      builder: (context, snapshot) {
                        ...
                        final chartApiReportGetResponse = snapshot.data!;
                                ...
                                xData: functions
                                    .summarizeLogs(
                                        functions.toDateTime(
                                            widget.reportParameter!.startTime),
                                        functions.toDateTime(
                                            widget.reportParameter!.endTime),
                                        ReportStruct.maybeFromMap(
                                                chartApiReportGetResponse
                                                    .jsonBody)!
                                            .usedLogs
                                            .toList())
                                    .xAxis,
