...
class EditSingleDeviceComponentWidget extends StatefulWidget {
  const EditSingleDeviceComponentWidget({
    super.key,
  ...
  @override
  State<EditSingleDeviceComponentWidget> createState() =>
      _EditSingleDeviceComponentWidgetState();
}

class _EditSingleDeviceComponentWidgetState
    extends State<EditSingleDeviceComponentWidget> {
  late EditSingleDeviceComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditSingleDeviceComponentModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final containerApiV1DeviceidGETResponse = snapshot.data!;
                            ...
                            children: [
                              ...
                              Switch(
                                value: _model.switchValue ??= getJsonField(
                                  containerApiV1DeviceidGETResponse.jsonBody,
                                  r'''$.active''',
                                ),
